...
public class SimpleFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final Button button_voto = rootView.findViewById(R.id.btn_emitirVoto);



        button_voto.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View view) {
                switch (mRadioButtonChoice) {
                    case YES: // User chose "Yes."
                        mListener.onButtonChoice(YES);
                        break;
                    case NO: // User chose "No."
                        mListener.onButtonChoice(NO);
                        break;
                    default:
                        mListener.onButtonChoice(NONE);
                        break;
